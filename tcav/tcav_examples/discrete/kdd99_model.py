...
def encode_variables(data):
    ...
    data2[:, categorical_indices] = encoder.fit_transform(
        data2[:, categorical_indices])
    return data2
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name',
                        type=str,
                        help='Name for the model. Example: model.h5')
    parser.add_argument('--labels_path',
                        type=str,
                        help='path containing labels for the model.')
