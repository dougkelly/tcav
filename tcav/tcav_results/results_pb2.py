...
_RESULT_CAVACCURACIES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='positive_set_accuracy',
            full_name='tcav_results.Result.CAVaccuracies.positive_set_accuracy',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='negative_set_accuracy',
            full_name='tcav_results.Result.CAVaccuracies.negative_set_accuracy',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='tcav_results.Result.CAVaccuracies.overall_accuracy',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
...
_RESULT = _descriptor.Descriptor(
    ...
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(name='cav_key',
                                    full_name='tcav_results.Result.cav_key',
                                    index=0,
                                    number=1,
                                    type=9,
                                    cpp_type=9,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='cav_concept',
                                    full_name='tcav_results.Result.cav_concept',
                                    index=1,
                                    number=2,
                                    type=9,
                                    cpp_type=9,
                                    ...
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='negative_concept',
            full_name='tcav_results.Result.negative_concept',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='target_class',
            full_name='tcav_results.Result.target_class',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='cav_accuracies',
            full_name='tcav_results.Result.cav_accuracies',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
            ...
            serialized_options=None,
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='i_up',
                                    full_name='tcav_results.Result.i_up',
                                    index=5,
                                    number=6,
                                    type=2,
                                    cpp_type=6,
                                    ...
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='val_directional_dirs_abs_mean',
            full_name='tcav_results.Result.val_directional_dirs_abs_mean',
            index=6,
            number=7,
            type=2,
            cpp_type=6,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='val_directional_dirs_mean',
            full_name='tcav_results.Result.val_directional_dirs_mean',
            index=7,
            number=8,
            type=2,
            cpp_type=6,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='val_directional_dirs_std',
            full_name='tcav_results.Result.val_directional_dirs_std',
            index=8,
            number=9,
            type=2,
            cpp_type=6,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='val_directional_dirs',
            full_name='tcav_results.Result.val_directional_dirs',
            index=9,
            number=10,
            type=2,
            cpp_type=6,
            ...
            serialized_options=None,
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='note',
                                    full_name='tcav_results.Result.note',
                                    index=10,
                                    number=11,
                                    type=9,
                                    cpp_type=9,
        ...
        _descriptor.FieldDescriptor(name='alpha',
                                    full_name='tcav_results.Result.alpha',
                                    index=11,
                                    number=12,
                                    type=2,
                                    cpp_type=6,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='bottleneck',
                                    full_name='tcav_results.Result.bottleneck',
                                    index=12,
                                    number=13,
                                    type=9,
                                    cpp_type=9,
...
_RESULTS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(name='results',
                                    full_name='tcav_results.Results.results',
                                    index=0,
                                    number=1,
                                    type=11,
                                    cpp_type=10,
