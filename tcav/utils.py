...
def print_results(results,
  ...
  """
    ...
    for result in results:
        ...
        result_summary[result['cav_concept']][result['bottleneck']].append(
            result)
    ...
    for concept in result_summary:
        ...
        if not is_random_concept(concept):
            ...
            for bottleneck in result_summary[concept]:
                i_ups = [
                    item['i_up'] for item in result_summary[concept][bottleneck]
                ]
                ...
                print(
                    ...
                    (bottleneck, np.mean(i_ups), np.std(i_ups),
                     ...
                     "undefined" if np.isnan(p_val) else
...
def result_to_proto(result):
  ...
  """
    ...
    result_proto.cav_accuracies.positive_set_accuracy = result[
        "cav_accuracies"][positive_set_name]
    result_proto.cav_accuracies.negative_set_accuracy = result[
        "cav_accuracies"][negative_set_name]
