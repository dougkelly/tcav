...
class UtilsTest(googletest.TestCase):
    ...
    def test_process_what_to_run_expand(self):
        all_concepts, pairs_to_test = process_what_to_run_expand(
            self.pair_to_test_one_concept, num_random_exp=2)
        self.assertEqual(
            sorted(all_concepts),
            sorted(['t1', 'c1', 'c2', 'random500_1', 'random500_0']))
        self.assertEqual(
            sorted(pairs_to_test),
            sorted([('t1', ['c1', 'random500_0']), ('t1', ['c1',
                                                           'random500_1']),
                    ('t1', ['c2', 'random500_0']), ('t1', ['c2',
                                                           'random500_1'])]))
    ...
    def test_process_what_to_run_expand_specify_dirs(self):
        ...
        self.assertEqual(
            sorted(pairs_to_test),
            sorted([('t1', ['c1', 'random_dir1']), ('t1', ['c1',
                                                           'random_dir2']),
                    ('t1', ['c2', 'random_dir1']), ('t1', ['c2',
                                                           'random_dir2'])]))

    def test_process_what_to_run_concepts(self):
        self.assertEqual(process_what_to_run_concepts(self.pairs_to_test), [
            ['t1', ['c1']],
            ['t1', ['c2']],
            ['t2', ['c1']],
            ['t2', ['c2']],
    ...
    def test_process_what_to_run_randoms(self):
        self.assertEqual(
            sorted(
                process_what_to_run_randoms(self.pairs_to_test, 'random500_1')),
